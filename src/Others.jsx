...
const Others =({select , seatDeselect})=> {
    return (
        <div className="bg-gray-100 p-4 w-[450px] rounded-lg">
        ...
        <input className="border-2 rounded-lg h-10 w-full" type="text" placeholder="Have any coupon ?" name="" id="" />
        <button className="bg-[rgb(29,209,0)] py-2 px-4 text-white rounded-lg ml-2">Apply</button>
        </div>
        <div className="flex justify-between">
